...
def mars_hemispheres(browser):
 # # D1: Scrape High-Resolution Mars’ Hemisphere Images and Titles
    ...
    hemisphere_image_urls = hemisphere_soup.find_all('div', class_=['description'])
    ...
    for hemisphere_image_url in hemisphere_image_urls:
        try:
            # Find the relative image url 
            img_url_rel = hemisphere_image_url.a['href']
            # Use the base url to create an absolute url
            ...
            hemispheres = {'img_url': img_url, 'title': title.get_text()}
